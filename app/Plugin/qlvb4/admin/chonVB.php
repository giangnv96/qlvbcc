...
</script><br><h3>Chọn loại văn bằng</h3>
<form action="<?php echo $urlPlugins ?>admin/qlvb-admin-chonSV.php" method="GET" accept-charset="utf-8">
	<div class="row">
		<div class="col-md-4">
			<input type="hidden" name="idLop" value="<?php echo $idLop ?>">
			<label>Chọn loại văn bằng</label>
