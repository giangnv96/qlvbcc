...
<form action="" method="post" accept-charset="utf-8">
	...
	<div class="row">
		<div class="col-md-6">
			...
			<input type="date" name="ngaycap" placeholder="" value="<?php echo $data['Chungchi']['ngaycap'] ?>" class="form-control" required="">
		</div>
		<div class="col-md-6">
			<label>Số hiệu:</label>
		...
		<div class="col-md-6">
			<label>Từ ngày:</label>
			<input type="date" name="tungay" placeholder="" value="<?php echo $data['Chungchi']['tungay'] ?>" class="form-control" required="">
		</div>
		<div class="col-md-6">
			<label>Đến ngày:</label>
			<input type="date" name="denngay" placeholder="" value="<?php echo $data['Chungchi']['denngay'] ?>" class="form-control" required="">
		</div>
		<div class="col-md-6">
			...
			<select name="xl" required class="form-control">
				...
				?>
				<option value="<?php echo $value['id'] ?>" <?php (isset($data['Chungchi']['xl'])&&$data['Chungchi']['xl']==$value['id'])?'selected="selected"':'' ?>><?php echo $value['name'] ?></option>
				<?php
				}
				} ?>
			</select>
