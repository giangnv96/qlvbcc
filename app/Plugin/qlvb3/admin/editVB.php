...
<form action="" method="post" accept-charset="utf-8">
	...
	<div class="row">
		<div class="col-md-6">
			...
			<input type="text" name="" placeholder="" value="<?php echo $data['Vanbang']['ngaycap'] ?>" class="form-control" required="">
		</div>
		<div class="col-md-6">
			<label>Số hiệu:</label>
			<input type="text" name="" placeholder="" value="<?php echo $data['Vanbang']['sohieu'] ?>" class="form-control" required="">
		</div>
		<div class="col-md-6">
			<label>Số vào sổ:</label>
			<input type="text" name="" placeholder="" value="<?php echo $data['Vanbang']['sovaoso'] ?>" class="form-control" required="">
		</div>
		<div class="col-md-6">
			<label>Số quyết định:</label>
			<input type="text" name="" placeholder="" value="<?php echo $data['Vanbang']['soqd'] ?>" class="form-control" required="">
		</div>
		<div class="col-md-6">
			<label>Người cấp:</label>
			<input type="text" name="" placeholder="" value="<?php echo $data['Vanbang']['nguoicap'] ?>" class="form-control" required="">
		</div>
		<div class="col-md-6">
			<label>Chức vụ:</label>
			<input type="text" name="" placeholder="" value="<?php echo $data['Vanbang']['chucvu'] ?>" class="form-control" required="">
		</div>
		<div class="col-md-6">
