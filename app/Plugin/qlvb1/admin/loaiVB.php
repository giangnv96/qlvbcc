...
<table class="table table-bordered table-hover">
	...
	<tr>
		...
		<td><a href="#" onclick='edit("<?php echo $value['Loai']['id'] ?>","<?php echo $value['Loai']['code'] ?>","<?php echo $value['Loai']['name'] ?>","<?php echo $value['Loai']['des'] ?>")' title="">Sửa</a>|<a href="<?php echo $urlPlugins ?>admin/qlvb-admin-delLoaivb.php?id=<?php echo $value['Loai']['id'] ?>" onclick="return confirm('Bạn có chắc chắn muốn xóa không?')"  title="">Xóa</a></td>
	</tr>
	<?php }
	}else
	echo '<tr>
