    ...
    setVariable('listData',$listData);
        ...
        if (!empty($_REQUEST['code'])) {
            ...
            if (empty($_REQUEST['id'])) {
                if (empty($check)) {
                    $model->save($save);
        $model->redirect($urlPlugins . 'admin/qlvb-admin-dsNganh.php?stt=1');
                }
                else
                {
                    echo '<script>
            ...
            {   
               ...
               $dk= array('_id'=>$idDel);
                ...
                $model->redirect($urlPlugins . 'admin/qlvb-admin-dsNganh.php?stt=2');
            }
...
function delNganh()
{
    ...
    if (checkAdminLogin()) {
        ...
        $model->redirect($urlPlugins . 'admin/qlvb-admin-dsNganh.php?stt=3');
        }
        else
