...
function loaiVB()
{
    ...
    setVariable('listData',$listData);
        ...
        $modelLoaivb->redirect($urlPlugins . 'admin/qlvb-admin-loaiVB.php?stt=1');
            }
            else
            {
        ...
        $modelLoaivb->redirect($urlPlugins . 'admin/qlvb-admin-loaiVB.php?stt=2');
            }
...
function loaiCC()
{
    ...
    setVariable('listData',$listData);
        ...
        $modelLoaicc->redirect($urlPlugins . 'admin/qlvb-admin-loaiCC.php?stt=1');
            }
            else
            {	
            	$idDel= new MongoId($_REQUEST['id']);
        ...
        $modelLoaicc->redirect($urlPlugins . 'admin/qlvb-admin-loaiCC.php?stt=2');
            }
