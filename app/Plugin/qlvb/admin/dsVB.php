	...
	<table class="table table-responsive table-hover table-bordered">
		...
		<tbody>
			...
			<tr>
				...
				<td><a href="<?php echo $urlPlugins ?>admin/qlvb-admin-editVB.php?id=<?php echo $value['Vbcc']['id'] ?>" title="">Sửa</a> | <a href="<?php echo $urlPlugins ?>admin/qlvb-admin-delVB.php?id=<?php echo $value['Vbcc']['id'] ?>" title="">Xóa</a> | <a href="<?php echo $urlPlugins ?>admin/qlvb-admin-VBdetail.php?id=<?php echo $value['Vbcc']['id'] ?>" title="">Chi tiết</a></td>
			</tr>
			<?php
			}
			}
